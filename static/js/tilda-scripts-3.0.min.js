  ...
  (l.scrollBarWidth = Math.abs(
    ...
    !l.isInited &&
      ...
      (e = document.body.style.paddingRight) &&
        document.body.setAttribute("data-tilda-initial-padding-right", e),
...
function t_scrollBarWidthCompensator__cancel() {
  ...
  t &&
    ...
    Array.prototype.forEach.call(t.fixedElements, function (t) {
      t = t.el;
      t.hasAttribute("data-tilda-initial-right")
        ? ((t.style.right = t.getAttribute("data-tilda-initial-right")),
          t.removeAttribute("data-tilda-initial-right"))
        : t.style.removeProperty("right"),
        t.hasAttribute("data-tilda-initial-width")
          ? ((t.style.width = t.getAttribute("data-tilda-initial-width")),
            t.removeAttribute("data-tilda-initial-width"))
...
(window.isSearchBot = !1),
  ...
  t_onReady(function () {
    ...
    (t = e ? e.getAttribute("data-tilda-project-lang") : t) &&
  ...
  t_onReady(function () {
    ...
    var t = document.querySelector("html"),
      ...
      m =
        ...
        document.querySelector(".t-tildalabel")),
      p = p
        ? Math.max(
            p.scrollHeight,
            p.offsetHeight,
