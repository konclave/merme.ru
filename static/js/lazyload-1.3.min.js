...
!(function (t, e) {
  ...
  function _(t, e, o, i) {
    ...
    if (i) {
        ...
        c =
          ((!b(e, "t-slds__bgimg") && !b(e, "t-slds__img")) ||
            ...
            (!1 ===
              A(
                (c =
                  (c = v(e, "t-slds__wrapper")) || v(e, "t-slds__container")),
            ...
            ? ((l = getComputedStyle(e).backgroundPosition) &&
              ...
              (u =
                "contain" == getComputedStyle(e)["background-size"]
                  ? "contain"
                  : "cover"),
              "fixed" == getComputedStyle(e)["background-attachment"] &&
                (m = !0))
            : (m = !0),
      ...
      1 < _ && ((r = (n = z(u, r, d, _))[0]), (d = n[1])),
        ...
        (i =
          "y" === window.lazy_err_static && 0 === i.indexOf("static/")
            ? i.replace("static/", "https://static3.tildacdn.com/")
            : i) &&
  ...
  function p(t, e, o) {
    if ("string" == typeof e && null != e && "" != e) {
      if ((console.log("lazy loading err"), 0 === e.indexOf("static/")))
        return (
          (window.lazy_err_static = "y"),
          void m(t, e.replace("static/", "https://static3.tildacdn.com/"))
        );
      if (
        ...
        "" !== n &&
          ...
          "function" != typeof t_errors__sendCDNErrors &&
            (((t = document.createElement("script")).src =
              "static/js/tilda-errors-1.0.min.js"),
